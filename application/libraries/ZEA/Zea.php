													...
													if(!empty($dvalue['id']))
													{
														...
														<tr data-id="<?php echo $dvalue['id'] ?>">
															...
															if($this->edit == true)
															{
																?>
																<td>
																	<a href="<?php echo $this->edit_link.$dvalue['id'] ?>" class="btn btn-default" title="Klik untuk mengubah" data-toggle="tooltip" data-placement="top"> <span class="fa fa-pencil"></span></a>
																</td>
																<?php
															}
															if($this->delete == true)
															{
																...
																<td>
																	<div class="checkbox">
																		<label>
																			<input type="checkbox" class="del_check" name="del_row[]" value="<?php echo $dvalue['id']; ?>"> <span class="fa fa-trash"></span>
																		</label>
																	</div>
																</td>
																<?php
